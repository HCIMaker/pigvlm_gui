...
SCORER = "Jiale"  # do not change

# ── Mode toggle ───────────────────────────────────────────────────────
MULTI_ANIMAL = False  # do not change

# Single-animal project path
SOW_DLC_PROJECT = Path(__file__).parent  # auto-resolves to this split
# Multi-animal project path
MULTI_DLC_PROJECT = Path(__file__).parent  # auto-resolves to this split
